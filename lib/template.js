...
template.NEWNODEFORM = function(nodelist){
	...
	return `<form action="/create/newnode" class="newnodeform" onsubmit="return checking_node_double()" method="post">
		...
		<div style="color:red; font-size:0.9rem; margin-top:0.3rem; margin-left:0.3rem">  *10글자 이내, 특수문자&공백 제외, 숫자로 시작 안됨  </div>
...
<div id = "header_info">
	<div class="west">
		<label class="West_opp">반대노드1
			<select class="opps" id="west_opp">
				<option selected value=""></option>
			</select>
		</label>
		<label class="West_name">포트이름1
	...
	<div class="east">
		<label class="East_opp">반대노드2
			<select class="opps" id="east_opp">
				<option selected value=""></option>
			</select>
		</label>
		<label class="East_name">포트이름2
